...
TEST(CaveTalkCppTests, SpeakListenLog)
{
    ...
    const CaveTalk_Message_t hw = "Hello World!";
    ...
    const CaveTalk_Message_t ooga_booga_msg = "Ooga Booga Ooga Booga Ooga Booga Ooga Booga Ooga Booga Ooga Booga Ooga Booga Ooga Booga!";
